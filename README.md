...
3. **Next step grants (Microgrants)**: Grants of $5,000 in FIL are available to support taking the next step after you have created an initial prototype with IPFS. These grants are intended for independent developers, small studios, non-profits, activists, and researchers. Applicants may be working independently, or as part of a course or hackathon.
Acceptance criteria are very simple, and work is expected to be complete within 2 months. See [next step grant details](https://github.com/filecoin-project/devgrants/blob/master/microgrants/microgrants.md) for more information on how to submit a proposal. Relevant proposals will be labeled [`proposal-type:nextstep`](https://github.com/filecoin-project/devgrants/labels/proposal-type%3Aopen).
