...
**Proposal Category:** Choose one of `core-dev`, `app-dev`, `devtools-libraries`, `technical-design`, `docs` Learn what these categories are here: {https://github.com/filecoin-project/devgrants/tree/master/open-grants}"
